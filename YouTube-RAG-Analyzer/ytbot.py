...
url = "https://www.youtube.com/watch?v=3Cni6_JubQk"
...
def process(transcript):
    ...
    return txt
# ==========================================
# CÓDIGO FINAL DE PRUEBA (Reemplaza el final de tu script con esto)
# ==========================================

url = "https://www.youtube.com/watch?v=3Cni6_JubQk"
print(f"Obteniendo transcript para: {url}...")
transcript_real = get_transcript(url)

if transcript_real:
    # Pasamos el transcript real a la función process
    formatted_transcript = process(transcript_real)
    
    print("\n--- TRANSCRIPT PROCESADO ---")
    print(formatted_transcript)
else:
    print("No se pudo obtener el transcript del video.")
...
# Aquí simulamos un contexto cualquiera solo para probar el formato:
context = "El video menciona el repositorio Open Montage, que es un agente de IA para editar videos."
question = "¿Cuáles son los repositorios de GitHub mencionados en el video?"
