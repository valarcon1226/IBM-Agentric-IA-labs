...
| 10 | [Docker Compose Lab](10-docker-compose-lab/)                     | Shared production topology for all services                     | Docker Compose, Traefik, Postgres, Redis    | Scaffolded  | Compose file + backend skeleton; not verified in CI |
